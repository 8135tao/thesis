...
\begin{equation*}%\label{est:asy_eq}
\begin{split}
...
\]
as a densely defined operator on $ \mathcal{C}(\sigma_*,L)$. So we conclude that 
\begin{equation}\label{est:asy_eq}
...
\]
for some constant $C_2$ independent of $L$ by \eqref{est:asy_eq}.
